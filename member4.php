...
<body>
    <div class="container">
        <div class="header">
            <img src="abpic.png" alt="Profile Photo" class="profile-photo">
            <button class="update-button" onclick="location.href='index.php'"><i class="fas fa-home"></i>Logout</button>
        </div>
        ...
        <table>
            ...
            $college_id = mysqli_real_escape_string($con, '2132001');
